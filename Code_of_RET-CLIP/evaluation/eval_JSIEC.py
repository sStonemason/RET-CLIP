...
class JSIECDataset(data.Dataset):
...
def eval_multiLabelCls_ViT(model, device):
    ...
    if TRAIN:
        ...
        train_dataset = JSIECDataset(data_dir=DATA_DIR, label_dir=LABEL_DIR, split='train', imsize=224)
        val_dataset = JSIECDataset(data_dir=DATA_DIR, label_dir=LABEL_DIR, split='valid', imsize=224)
        test_dataset = JSIECDataset(data_dir=DATA_DIR, label_dir=LABEL_DIR, split='test', imsize=224)
